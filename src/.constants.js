module.exports = Object.freeze({
  TOKEN: '1273494992:AAHJYRoLrI4E1sEFbV8tOqYjK_NiKBFV0hI', //required
  ...
  GDRIVE_PARENT_DIR_ID:  '1S7MOVyhaLoxrOjqiSekI49d1DsgJmoK3', // for directorty eg. https://drive.google.com/drive/folders/1p7pHhSh2yboWePmo53DnVr3xkAYiojP9 use 1p7pHhSh2yboWePmo53DnVr3xkAYiojP9
  SUDO_USERS: [892746224],	// Telegram user IDs. These users can use the bot in any chat. required, get it using https://t.me/YourTGid_Bot
  AUTHORIZED_CHATS: [-457822743],	// Telegram chat IDs. Anyone in these chats can use the bot. Add https://t.me/YourTGid_Bot to Group and click /id
  ...
  DOWNLOAD_NOTIFY_TARGET: {  // Information about the web service to notify on download completion. not required
    ...
    COMMANDS_USE_BOT_NAME: {
      ...
      NAME: "@lamaphssi_bot" //Enter your Bot Username here if above is set to true.
    }
});
